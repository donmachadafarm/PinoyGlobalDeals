...
<h2>Create your Pinoy Global Deals Free Account</h2>
...
if(isset($_POST["register"])){
  ...
  $sql = "INSERT INTO mt_users (first_name, lastname, email_add, mobile_num, street, city, country, province, password, gender, ip, activate_email) "
          . "VALUES ('$firstName', '$lastName', '$email', '$mobile_num', '$street', '$city', '$country', '$province', '$password', '$gender', '$ip', '$activate_email')";
  $conn->query($sql);
}
?>
</body>
